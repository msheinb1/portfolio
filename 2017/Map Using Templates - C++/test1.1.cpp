...
int main(int argc, char *argv[]) {
    //cs540::Map<std::string, int> m1;
    //run_test<cs540::Map>(0);
    //cs540::Map<int, char> m{{0, 'H'}, {2, ' '}, {1, 'i'}};
    cs540::Map<int, char> m;
    m.insert(std::pair<int,char>(0,'H'));
    //m.insert(std::pair<int,char>(2,' '));
    //m.insert(std::pair<int,char>(1,'i'));
    m.inOrder();
    //printf("\nSize: %d\n", (int)m.size());
    //printf("\n");
    m.erase(0);
    ...
    /*
    printf("New Map\n");
    cs540::Map<int, char> copy;
    copy = m;
    //m.~Map<int, char>();
    //copy.inOrder();
    if (m != copy) {
        printf("Maps are unequal\n");
    } else {
        printf("Maps are equal\n");
    }
    
    m = m;
    cs540::Iterator<int, char> begin = m.begin();
    
    cs540::Iterator<int, char> mIt = begin;
    if (mIt.thisNode->nodeVal->first == m.begin().thisNode->nodeVal->first) {
        printf("Success \n");
    } else {
        printf("not found\n");
    }
    ...
    cs540::Iterator<int, char> it1 = m.begin();
    cs540::Iterator<int, char> it2 = m.end();
    cs540::ConstIterator<int, char> c_it1 = m.begin();
    cs540::ConstIterator<int, char> c_it2 = m.end();
    cs540::ReverseIterator<int, char> r_it1 = m.begin();
    cs540::ReverseIterator<int, char> r_it2 = m.end();
